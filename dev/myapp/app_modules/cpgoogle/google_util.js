...
module.exports = (function() {
  ...
  var list = function(FolderID, orderkey, callback) {
  ...
  var downloadFile = function(res, fileId) {
  ...
  var uploadFile = function(FileInfo, Folder) {
    var usr_session = null;
    initGoogle(usr_session, function(oauth2Client) {
      var drive = google.drive({
        version: 'v3',
  ...
  var updateFile = function(Newname, fileId) {
    var usr_session = null;
    initGoogle(usr_session, function(oauth2Client) {
      var drive = google.drive({
        version: 'v3',
  ...
  var updateDir = function(fileId, folderId) {
    var usr_session = null;
  ...
  var searchName = function(Filename) {
    var usr_session = null;
  ...
  var searchType = function(Filetype, callback) {
    var usr_session = null;
  ...
  var makeDir = function(foldername, FolderID) {
    var usr_session = null;
  ...
  var getThumbnailLink = function(fileId) {
    var usr_session = null;
